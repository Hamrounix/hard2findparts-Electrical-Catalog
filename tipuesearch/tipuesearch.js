  ...
  $.fn.tipuesearch = function (options) {
    ...
    return this.each(function () {
      ...
      if (getURLP("q")) {
        ...
        /*$("#frameContainer").hide();*/
        //$("#frameContainer").attr("src", "search.html");
      ...
      function getTipueSearch(start, replace) {
        ...
        var out = "";
        // var out = "<h1>Bonjour</h1>";
        //var out = '<iframe  src="" name="targetframe" allowTransparency="true" scrolling="yes" frameborder="0" marginwidth="0"> </iframe>';
